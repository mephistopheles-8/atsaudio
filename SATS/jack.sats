...
fun jack_client_open(string, jack_options_t, &jack_status_t? >> jack_status_t) : cPtr0(jack_client_t) = "mac#"
...
fun jack_port_register(cPtr0(jack_client_t), string, string, enum_JackPortFlags, ulint) : cPtr0(jack_port_t) = "mac#"
