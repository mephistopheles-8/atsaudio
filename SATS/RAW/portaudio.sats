...
macdef paClipOff = $extval(int,"paClipOff")
macdef paInputOverflow = $extval(int,"paInputOverflow")
macdef paPrimeOutputBuffersUsingStreamCallback = $extval(int,"paPrimeOutputBuffersUsingStreamCallback")
...
macdef paNoFlag = $extval(int,"paNoFlag")
macdef paInt16 = $extval(int,"paInt16")
macdef paInt24 = $extval(int,"paInt24")
macdef paInt32 = $extval(int,"paInt32")
macdef paNeverDropInput = $extval(int,"paNeverDropInput")
macdef paFramesPerBufferUnspecified = $extval(int,"paFramesPerBufferUnspecified")
macdef paFloat32 = $extval(int,"paFloat32")
macdef paPlatformSpecificFlags = $extval(int,"paPlatformSpecificFlags")
...
macdef paUInt8 = $extval(int,"paUInt8")
macdef paDitherOff = $extval(int,"paDitherOff")
macdef paInt8 = $extval(int,"paInt8")
...
fun Pa_GetErrorText(PaError) : cPtr0(char) = "mac#"
...
typedef PaSampleFormat = $extype"PaSampleFormat"
...
typedef PaStreamFlags = $extype"PaStreamFlags"
...
typedef PaStreamCallback = (ptr, ptr, ulint, cPtr0(PaStreamCallbackTimeInfo), PaStreamCallbackFlags, ptr) -> int

fun Pa_OpenStream(cPtr0(cPtr0(PaStream)), cPtr0(PaStreamParameters), cPtr0(PaStreamParameters), double, ulint, PaStreamFlags, cPtr0(PaStreamCallback), ptr) : PaError = "mac#"
